/****************************************************************************
** Meta object code from reading C++ file 'input_widget.hpp'
**
...
#error "The header file 'input_widget.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 21, 7) // "command"
    ...
    "InputWidget\0changed\0\0command"
};
...
void InputWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (InputWidget::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&InputWidget::changed)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject InputWidget::staticMetaObject = {
    { &QPlainTextEdit::staticMetaObject, qt_meta_stringdata_InputWidget.data,
      qt_meta_data_InputWidget,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void InputWidget::changed(QString _t1)
{
